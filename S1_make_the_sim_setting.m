...
%         clearvars -except target_name_arr ti model_folder layer_mus mus_table sim_set sim_version n g mode_idx mode ;
        ...
        target_folder = fullfile(target_name,mode(mode_idx));
